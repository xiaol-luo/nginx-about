...
class Schema 
{
  ...
  explicit Schema(GConfSchema* castitem, bool make_a_copy = false);
  ...
  GConfSchema*       gobj()       { return gobject_; }
  const GConfSchema* gobj() const { return gobject_; }
