...
protected:
  ...
  static void change_orient_callback(PanelApplet* self, PanelAppletOrient p0);
  static void change_size_callback(PanelApplet* self, guint p0);
  static void change_background_callback(PanelApplet* self, PanelAppletBackgroundType p0, GdkColor* p1, GdkPixmap* p2);
  static void move_focus_out_of_applet_callback(PanelApplet* self, GtkDirectionType p0);
