...
//#endif
   ...
   * @param length Return location for the length of the returned list, or <tt>0</tt>.
  ...
  /** Return value: a newly allocated <tt>0</tt> terminated array of strings.  Use
   * @param length Return location for the number of groups returned, or <tt>0</tt>.
