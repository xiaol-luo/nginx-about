...
/* QUEUE DRAWS */
   ...
   * <link linkend="child-properties">child property</link> @a child_property 
   * on @a widget.
   * 
   ...
   * yourself by calling <literal>gtk_widget_set_can_default ( @a widget,
   * <tt>true</tt>)</literal>. The default widget is activated when 
  ...
  /** Returns: <tt>true</tt> if the widget is sensitive
  ...
  /** Returns: <tt>true</tt> if the widget is effectively sensitive
   ...
   * calling this function with @a has_window = <tt>true</tt>.
   * 
   ...
   * NO_WINDOW widget that <emphasis>does</emphasis> draw on @a widget->window, 
  ...
  /** Return value: @a widget's window.
   ...
   * For instance a @a clip_rect <literal>{ +5, +5, -10, -10 }</literal> will
   ...
   * coordinates upon return. A @a clip_rect of <literal>{ -1, -1, 0, 0 }</literal>
