...
public:
  ...
  /** Return value: a List of action groups. The list is owned by GTK+
   * @return A List of action groups. The list is owned by GTK+ 
   ...
   * @return A newly-allocated SList of all toplevel widgets of the
   * requested types.  Free the returned list with Glib::slist_free().
   * 
   * @newin{2,4}.
   */
