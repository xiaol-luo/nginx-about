...
public:
   ...
   * description_set_style().
   * @return The style field for the font description.
   * Use description_get_set_fields() to find out if
   ...
   * description_set_variant().
   * @return The variant field for the font description. Use
   * description_get_set_fields() to find out if
   * the field was explicitly set or not.
   */
   ...
   * exclusive with description_set_absolute_size().
   ...
   * pixel font. Use description_set_absolute_size() if you need
   * a particular size in device units.
   */
  void set_size(int size);
  
  /** Gets the size field of a font description.
   * See description_set_size().
   * @return The size field for the font description in points or device units.
   * You must call description_get_size_is_absolute()
   * to find out which is the case. Returns 0 if the size field has not
   * previously been set or it has been set to 0 explicitly.
   * Use description_get_set_fields() to
   * find out if the field was explicitly set or not.
   */
  int get_size() const;
  
  /** Sets the size field of a font description, in device units. This is mutually
   * exclusive with description_set_size() which sets the font size
   * in points.
   * 
   * @newin{1,8}
   ...
   * See description_set_size() and description_set_absolute_size().
   * @return Whether the size for the font description is in
   * points or device units.  Use description_get_set_fields() to
   ...
   * description_to_string(), but with underscores instead of
