...
public:
   ...
   * 
   * <note>
   * If @a window is not a toplevel, it is <emphasis>much</emphasis> better
   ...
   * 
   * After calling this with a non-<tt>0</tt> @a name, calls to gdk_window_set_title()
...
*/
   ...
   * @param width Width of redirection.
   * @param height Height of redirection.
   */
